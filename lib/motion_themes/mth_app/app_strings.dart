...
class AppString {
  ...
  // HOME ROUTE
  // Badge Assignment Screen
  static const String badgeAssignmentTitle = "Badge Assignment";

  // DataTable Column Headers
  static const String badgeNameColumn = "Badge Name";
  static const String efsRangeColumn = "EFS Range";
  static const String descriptionColumn = "Description";

  // DataTable Rows (Badge Data)
  static const String timeNoviceBadge = "Time Novice";
  static const String timeNoviceRange = "0-24";
  static const String timeNoviceDescription =
      "Just starting out on your time management journey.";

  static const String focusedBeginnerBadge = "Focused Beginner";
  static const String focusedBeginnerRange = "25-49";
  static const String focusedBeginnerDescription =
      "Making progress and developing good time habits.";

  static const String timeProBadge = "Time Pro";
  static const String timeProRange = "50-74";
  static const String timeProDescription =
      "Efficiently managing tasks and prioritizing effectively.";

  static const String timeMasterBadge = "Time Master";
  static const String timeMasterRange = "75-99";
  static const String timeMasterDescription =
      "Exceptional time management skills and productivity.";

  static const String timeWizardBadge = "Time Wizard";
  static const String timeWizardRange = "100";
  static const String timeWizardDescription =
      "The ultimate time master, achieving peak efficiency.";
